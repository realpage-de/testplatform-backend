<?php
echo $this->Form->create($data, ['ajax' => true, 'api' => '1/post/json', 'url' => ['action' => 'add'], 'callback-success' => 'Users.Add{saveSuccess}', 'callback-validation-failure' => 'Users.Add{saveValidationFailure}', 'callback-failure' => 'Users.Add{saveFailure}']);
?>
	...
	<div class="tab-pane fade show active" role="tabpanel" id="account">
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				...
				<?php echo $this->Form->text('password', ['value' => '', 'class' => 'form-control']); ?>
			</div>
		</div>
		<div class="form-row">
			<div class="form-group col-md-6">
...
<?php $this->Html->scriptBlock("window.app.Plugins.get('Users.Add{init}')();", ['block' => true]); ?>